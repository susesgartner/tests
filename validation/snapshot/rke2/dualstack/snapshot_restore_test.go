...
func (s *SnapshotDualstackRestoreTestSuite) TestSnapshotDualstackRestore() {
	...
	tests := []struct {
		...
		{"RKE2_Dualstack_Restore_ETCD", snapshotRestoreConfig[0], s.cluster},
		{"RKE2_Dualstack_Restore_ETCD_K8sVersion", snapshotRestoreConfig[1], s.cluster},
		{"RKE2_Dualstack_Restore_Upgrade_Strategy", snapshotRestoreConfig[2], s.cluster},
	}
