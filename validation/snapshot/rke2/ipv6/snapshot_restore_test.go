...
func (s *SnapshotIPv6RestoreTestSuite) TestSnapshotIPv6Restore() {
	...
	tests := []struct {
		...
		{"RKE2_IPv6_Restore_ETCD", snapshotRestoreConfig[0], s.cluster, defaults.RKE2},
		{"RKE2_IPv6_Restore_ETCD_K8sVersion", snapshotRestoreConfig[1], s.cluster, defaults.RKE2},
		{"RKE2_IPv6_Restore_Upgrade_Strategy", snapshotRestoreConfig[2], s.cluster, defaults.RKE2},
	}
