...
#### Run Commands:
1. `gotestsum --format standard-verbose --packages=github.com/rancher/tests/validation/certificates/k3s/ipv6 --junitfile results.xml --jsonfile results.json -- -tags=validation -run  -timeout=2h -v`
...
#### Run Commands:
1. `gotestsum --format standard-verbose --packages=github.com/rancher/tests/validation/certificates/k3s/dualstack --junitfile results.xml --jsonfile results.json -- -tags=validation -run  -timeout=2h -v`
...
#### Run Commands:
1. `gotestsum --format standard-verbose --packages=github.com/rancher/tests/validation/certificates/k3s --junitfile results.xml --jsonfile results.json -- -tags=validation -run  -timeout=2h -v`
