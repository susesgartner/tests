...
func (s *NodeReplacingTestSuite) TestReplacingNodes() {
	...
	tests := []struct {
		...
		{"RKE2_Node_Driver_Replace_Control_Plane", nodeRolesControlPlane, s.rke2Cluster.ID},
		{"RKE2_Node_Driver_Replace_ETCD", nodeRolesEtcd, s.rke2Cluster.ID},
		{"RKE2_Node_Driver_Replace_Worker", nodeRolesWorker, s.rke2Cluster.ID},
		{"K3S_Node_Driver_Replace_Control_Plane", nodeRolesControlPlane, s.k3sCluster.ID},
		{"K3S_Node_Driver_Replace_ETCD", nodeRolesEtcd, s.k3sCluster.ID},
		{"K3S_Node_Driver_Replace_Worker", nodeRolesWorker, s.k3sCluster.ID},
	}
