...
func TestCustomRKE2IPv6(t *testing.T) {
	...
	tests := []struct {
		...
		{"RKE2_IPv6_Custom_CIDR", r.standardUserClient, nodeRolesStandard, cidrCluster, cidrService, ""},
		{"RKE2_IPv6_Custom_Stack_Preference", r.standardUserClient, nodeRolesStandard, "", "", "ipv6"},
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			nestedRancherModuleDir, perTestTerraformOptions, keyPath, cluster := tfpCustom.CreateCustomCluster(t, tt.client, rancherConfig, terraformConfig, terratestConfig, defaults.RKE2, "validation/provisioning/ipv6")
