...
func TestCustom(t *testing.T) {
	...
	tests := []struct {
		...
		{"RKE2_Custom|etcd_cp_worker", r.standardUserClient, nodeRolesAll, false, r.client.Flags.GetValue(environmentflag.Short) || r.client.Flags.GetValue(environmentflag.Long)},
		{"RKE2_Custom|etcd_cp|worker", r.standardUserClient, nodeRolesShared, false, r.client.Flags.GetValue(environmentflag.Short) || r.client.Flags.GetValue(environmentflag.Long)},
		{"RKE2_Custom|etcd|cp|worker", r.standardUserClient, nodeRolesDedicated, false, r.client.Flags.GetValue(environmentflag.Long)},
		{"RKE2_Custom|etcd|cp|worker|windows", r.standardUserClient, nodeRolesDedicatedWindows, true, r.client.Flags.GetValue(environmentflag.Long)},
		{"RKE2_Custom|3_etcd|2_cp|3_worker", r.standardUserClient, nodeRolesStandard, false, r.client.Flags.GetValue(environmentflag.Long)},
	}
