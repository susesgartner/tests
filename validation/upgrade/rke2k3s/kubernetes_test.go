...
func (u *UpgradeKubernetesTestSuite) SetupSuite() {
	...
	u.rke2ClusterID, err = resources.ProvisionRKE2K3SCluster(u.T(), standardUserClient, extClusters.RKE2ClusterType.String(), u.rke2ClusterConfig, false, false)
	require.NoError(u.T(), err)

	u.k3sClusterID, err = resources.ProvisionRKE2K3SCluster(u.T(), standardUserClient, extClusters.K3SClusterType.String(), u.k3sClusterConfig, false, false)
	require.NoError(u.T(), err)
}
